...
$filename_photo = '..'. DIRECTORY_SEPARATOR . $config['folders']['images'] . DIRECTORY_SEPARATOR . $file;
$filename_thumb = '..'. DIRECTORY_SEPARATOR . $config['folders']['thumbs'] . DIRECTORY_SEPARATOR . $file;
